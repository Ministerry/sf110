...
reward_assignment = {
    ...
    "kill_mutation_logic" : 8.0,  # 精确捕捉到逻辑差异，含金量极高
    "manslaughter" : -5,
    "varies" : 1,
    "have_connection" : 2,
    "no_connection" : -2,
    ...
    "strong_assertion": 3,
    "survivor": -3.5,
    "generic_not_null": -4, # 防止模型只写 assertNotNull
}
...
with open("excution_qwen3_1.7_before_generated_predictions.json","w",encoding="utf-8") as f:
