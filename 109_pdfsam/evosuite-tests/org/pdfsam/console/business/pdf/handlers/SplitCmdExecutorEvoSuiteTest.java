...
public class SplitCmdExecutorEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      ...
      SplitParsedCommand splitParsedCommand0 = new SplitParsedCommand((File) null, "Unhandled operator in createAdditiveExpr(): ", pdfFileArray0[2], "NSPLIT", integerArray0, (Long) null, (Integer) null, null, false, false, 'v');
      try {
  ...
  public void test4()  throws Throwable  {
      ...
      SplitParsedCommand splitParsedCommand0 = new SplitParsedCommand(file0, "Unhandled operator in createAdditiveExpr(): ", pdfFileArray0[2], "Unhandled operator in createAdditiveExpr(): ", integerArray0, (Long) null, (Integer) null, null, true, true, 'v');
      try {
        splitCmdExecutor0.execute((AbstractParsedCommand) splitParsedCommand0);
        fail("Expecting exception: SplitException");
      } catch(SplitException e) {
